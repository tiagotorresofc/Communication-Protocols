...
const char* ssid = "Tiago";            // Substitua pelo seu SSID Wi-Fi
const char* password = "adelaide";  // Substitua pela sua senha Wi-Fi
const char* mqtt_server = "172.20.10.2"; // Substitua pelo endereço IP do seu servidor MQTT (Linux)
